...
* handle default property with dynamic require ([83d1d2d](https://github.com/Botfuel/botfuel-dialog/commit/83d1d2d))
...
* handle default or named export for Resolved ([afb7154](https://github.com/Botfuel/botfuel-dialog/commit/afb7154))
...
* added lock files to gitignore to prevent issues with release script ([74ce0ae](https://github.com/Botfuel/botfuel-dialog/commit/74ce0ae))
* added missing lock files ([4a5055e](https://github.com/Botfuel/botfuel-dialog/commit/4a5055e))
...
* update check commit script ([496ba22](https://github.com/Botfuel/botfuel-dialog/commit/496ba22))
...
* handle UserMessage with origin option in botfuel-adapter ([96b7e33](https://github.com/Botfuel/botfuel-dialog/commit/96b7e33))
...
<a name="12.0.0"></a>
# [12.0.0](https://github.com/Botfuel/botfuel-dialog/compare/v11.7.0...v12.0.0) (2018-11-22)


### Breaking change

* MongoBrain - return minimal amount of information from mongo ([7f9e0c5c](https://github.com/Botfuel/botfuel-dialog/commit/7f9e0c5c))
* MemoryBrain - return only the needed data in MemoryBrain.userSet method ([c53f1889](https://github.com/Botfuel/botfuel-dialog/commit/c53f1889))
