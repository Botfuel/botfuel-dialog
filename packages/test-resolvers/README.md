...
This sample bot illustrates resolvers.
...
You can get examples of intents here : https://github.com/Botfuel/botfuel-dialog/blob/master/packages/test-resolvers/intents.xlsx
